...
mysql -u root -p d_vigne < ../scripts_SQL/2_import_vigne.sql
...
mysql -u root -p d_vigne < ../scripts_SQL/3_import_cepage.sql
...
mysql -u root -p d_vigne < ../scripts_SQL/5_import_categorie.sql
...
mysql -u root -p d_vigne < ../scripts_SQL/8_remplissage_quantite.sql
...
mysql -u root -p d_vigne < ../scripts_SQL/9_remplissage_surface_detail.sql
