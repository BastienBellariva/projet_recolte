...
(SELECT * FROM t_quantite_detail WHERE id_categorie = 1 AND id_cepage = 2) AS aop_blanc,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 1 AND id_cepage = 1) AS aop_rouge,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 1 AND id_cepage = 3) AS aop_rose,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 1 AND id_cepage = 4) AS aop_vsi,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 3 AND id_cepage = 2) AS igp_blanc,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 3 AND id_cepage = 1) AS igp_rouge,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 3 AND id_cepage = 3) AS igp_rose,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 4 AND id_cepage = 2) AS vsig_blanc,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 4 AND id_cepage = 1) AS vsig_rouge,
(SELECT * FROM t_quantite_detail WHERE id_categorie = 4 AND id_cepage = 3) AS vsig_rose,
